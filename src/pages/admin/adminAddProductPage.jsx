...
<div className="w-full p-[50px] flex justify-center ">
    ...
    <h1 className="w-full mb-5 font-bold text-secondary text-xl bold flex items-center gap-1" ><MdOutlineProductionQuantityLimits/>Add New Product</h1>
        <div className="w-full bg-white p-5 flex flex-row flex-wrap justify-between rounded-xl">
            <div className="my-2.5 w-[40%]">
                <label>Product ID</label>
                <input type="text " value={productID} onChange={(e)=>{setID(e.target.value)}} className="w-full h-10
            ...
            <button onClick={addProduct}className="w-[49%] mt-5 py-3 rounded-2xl bg-linear-to-r from-accent to-secondary text-primary font-semibold text-lg border-2 border-secondary
